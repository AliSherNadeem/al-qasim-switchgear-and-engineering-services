...
const dropdownItemClasses =
  "hover:bg-green-50 hover:text-green-700 focus:bg-green-50 focus:text-green-700 data-active:bg-green-50 data-active:text-green-700 data-active:hover:bg-green-50 data-active:focus:bg-green-50";
                ...
                return (
                  <NavigationMenuItem key={item.href}>
                    ...
                    <NavigationMenuContent className="z-50 min-w-64 gap-1 bg-popover p-2">
                      ...
                      <NavigationMenuLink asChild className={dropdownItemClasses}>
                        <Link
                          href="/products"
                                ...
                                <li key={product.slug}>
                                  <SheetClose asChild>
                                    <Link
                                      ...
                                      className="flex h-10 items-center rounded-lg px-3 text-sm text-foreground/80 transition-colors hover:bg-green-50 hover:text-green-700"
                                    >
                                      {product.name}
                                    </Link>
                                  </SheetClose>
